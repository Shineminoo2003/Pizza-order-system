            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-3 offset-8">
                        <a href="{{ route('pizza#list') }}"><button class="btn bg-dark text-white my-3">List</button></a>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('pizza#create') }}" method="post" novalidate="novalidate" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" class="form-control @error('description') is-invalid @enderror" cols="30" rows="10" placeholder="Enter description..."></textarea>
                                    @error('description')
                                       <small>{{$message}}</small> 
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="cc-pament" name="waitingTime" type="number" class="form-control @error('waitingTime') is-invalid @enderror" aria-required="true" aria-invalid="false" placeholder="Enter waiting time...">
                                    @error('waitingTime')
                                       <small>{{$message}}</small> 
                                    @enderror
                                </div>
