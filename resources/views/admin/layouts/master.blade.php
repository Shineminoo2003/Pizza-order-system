            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="active has-sub">
                            <a class="js-arrow text-decoration-none" href="{{ route('pizza#list') }}">
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="header-wrap">
                            <h3>Admin Category Dashboard</h3>
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            ...
                                            <div class="account-dropdown__body">
                                                <div class="account-dropdown__item">
                                                    <a href="{{ route('pass#changePage') }}"
                                                        class="text-decoration-none">
                                                        <i class="fa-solid fa-lock"></i>Change Password</a>
                                                </div>
                                            </div>
                                            <div class="account-dropdown__footer py-2 d-flex justify-content-center">
                                                <form action="{{ route('logout') }}" method="POST">
                                                    @csrf
                                                    <button type="submit" class="btn btn-outline-primary px-3"><i
                                                            class="zmdi zmdi-power pe-1"></i>Logout</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
